...
Sono stati inseriti manualmente i dati contenenti i punteggi ottenuti dalle squadre citate. In seguito, sono stati inseriti i loghi precedentementi scaricati. È stato, in ultimo, creato il grafico. Nelle ultime righe del codice si hanno le animazioni.
```
library(ggplot2)
library(grid)
library(png)
...
logo_napoli <- readPNG("C:\\Users\\rodol\\OneDrive\\Desktop\\logo_napoli.png")
logo_inter <- readPNG("C:\\Users\\rodol\\OneDrive\\Desktop\\logo_inter.png")
logo_milan <- readPNG("C:\\Users\\rodol\\OneDrive\\Desktop\\logo_milan.png")
logo_juve <- readPNG("C:\\Users\\rodol\\OneDrive\\Desktop\\logo_juve.png")
